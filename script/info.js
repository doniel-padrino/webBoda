const traducciones = {
    es: {
        ...
        dudas2:"Una vez más te damos gracias por formar parte de esto, si tienes alguna duda o necesitas hablar con nosotros aquí tienes nuestros numeros:",
...
function cambiarIdioma(idioma){
    ...
    document.getElementById("tiFoto").textContent =
    traducciones[idioma].tiFoto;

    document.getElementById("conf").textContent =
    traducciones[idioma].conf;

    document.getElementById("pp1").textContent =
    traducciones[idioma].pp1;

    document.getElementById("pp2").textContent =
    traducciones[idioma].pp2;

    document.getElementById("pp3").textContent =
    traducciones[idioma].pp3;

    document.getElementById("pp4").textContent =
    traducciones[idioma].pp4;

    document.getElementById("pp5").textContent =
    traducciones[idioma].pp5;

    document.getElementById("pp6").textContent =
    traducciones[idioma].pp6;

    document.getElementById("pp7").textContent =
    traducciones[idioma].pp7;

    document.getElementById("pp8").textContent =
    traducciones[idioma].pp8;

    document.getElementById("pp9").textContent =
    traducciones[idioma].pp9;

    document.getElementById("rad1").textContent =
    traducciones[idioma].rad1;

    document.getElementById("rad2").textContent =
    traducciones[idioma].rad2;

    document.getElementById("alergias").textContent =
    traducciones[idioma].alergias;

    document.getElementById("boton").textContent =
    traducciones[idioma].boton;

    document.getElementById("gracias1").textContent =
    traducciones[idioma].gracias1;

    document.getElementById("gracias2").textContent =
    traducciones[idioma].gracias2;

    document.getElementById("fot1").textContent =
    traducciones[idioma].fot1;

    document.getElementById("fot2").textContent =
    traducciones[idioma].fot2;

    document.getElementById("fot3").textContent =
    traducciones[idioma].fot3;

    document.getElementById("dudas").textContent =
    traducciones[idioma].dudas;

    document.getElementById("dudas2").textContent =
    traducciones[idioma].dudas2;

    document.getElementById("placeholder1").placeholder =
    traducciones[idioma].placeholder1;

    document.getElementById("placeholder2").placeholder =
    traducciones[idioma].placeholder2;

    document.getElementById("placeholder3").placeholder =
    traducciones[idioma].placeholder3;
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Mostrar u ocultar intolerancias
    ...
    formulario.addEventListener("submit", function(e) {
        ...
        .then(data => {
            // Ocultar los textos y mostrar el mensaje de gracias
...
const infoSi =
    document.getElementById("info-si");
